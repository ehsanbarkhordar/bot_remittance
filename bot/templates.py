...
class BotMessages:
    ...
    inter_amount = "لطفاً مبلغ را به *ریال* وارد نمایید:"
    inter_citY_name = "لطفاً نام *شهر محل دریافت پول* را *انتخاب* و یا *وارد* کنید: "
    inter_receiver_name = "نرخ تبدیل ارز صرافی *افضلی-سخاوتی:*\nهر افغانی، *{} تومان*\nلطفاً نام دریافت کننده پول را " \
                          "*وارد* " \
                          "نمایید: ".format(eng_to_arabic_number(140))
    ...
    payment_date = "{}/{}/{} ساعت {}:{}".format(eng_to_arabic_number(now.year), eng_to_arabic_number(now.month),
                                     eng_to_arabic_number(now.day), eng_to_arabic_number(now.hour), eng_to_arabic_number(now.minute))
    money_request_photo_message = PhotoMessage(name="image.png", file_id="-2331685930511168256",
                                               access_hash="1314892980", file_size=210162,
                                               mime_type="image/jpeg",
                                               thumb="/9j/4AAQSkZJRgABAQAAAQABAAD"
                                                     ...
                                                     "/wAARCAA0AFoDASIAAhEBAxEB/8QAGwABAAMBAQEBAAAAAAAAAAAAAAQFBgMBBwL"
                                                     "/xAAxEAABBAEDAgMFCAMAAAAAAAABAAIDEQQFEiEiMQYTQSNCUWGBMjNSYnGRoeGSsdH"
                                                     "/xAAZAQEAAwEBAAAAAAAAAAAAAAAAAQIDBAX"
                                                     "/xAAjEQACAQMEAgMBAAAAAAAAAAAAAQIDESEEEiJBMTJCUWGR "
                                                     "/9oADAMBAAIRAxEAPwD6QiIgCIiAKJqcJmxCASC1wcCO"
                                                     "/CkSyeW29pKp8vVJzlQ48UkUPmO2lxG6ie3Ppf6FAS8HOfK8RTxgOrh7Twf"
                                                     "+Kc17X3tcDXeivn3iEZWLqTwZ5vKBFFxADj3ugAP4VtpevRyjGIqXJc4Ne2EX09uQOyi+bGcailJw"
                                                     "+jWoiKTQIiIAiISB3IQHHLjD4CTIYy3qDgapZnK8RS4M4ikD3xkX5poWPlwtDnQnIgewPFEEUqJmgZGdIBqEm6CL7tpHJ "
                                                     "+qhlZqTXHyXGm5w1DGdIGu2h1NcONw+Kq9Z0qXLcTDG+3UDRAPHY38lbaax"
                                                     "+OH472Fobyw1xSnKSxi5vC800Jk1Cdz "
                                                     "+b2ucX/74CttBwcWIytjicHRECyeO1+ivXND2lrhYPBUPBxX4skzSQYnHc0"
                                                     "+v1QrtV7k1ERCwREQBV2sNccb2cbnO "
                                                     "",
                                               file_storage_version=1, caption_text=TextMessage(""), height=200,
                                               width=200)
...
class BotButtons:
    back_to_main_menu = TemplateMessageButton("بازگشت به منوی اصلی ", "بازگشت به منوی اصلی", 0)
    help = TemplateMessageButton("راهنمایی", "راهنمایی", 0)
    register = TemplateMessageButton("ثبت نام", "ثبت نام", 0)
    remittance = TemplateMessageButton("انتقال پول", "انتقال پول", 0)
    money_changer = TemplateMessageButton("افضلی-سخاوتی", "افضلی-سخاوتی", 0)
    cities = [TemplateMessageButton("کابل", "کابل", 0), TemplateMessageButton("هرات", "هرات", 0),
              TemplateMessageButton("مزار شریف", "مزار شریف", 0),
              TemplateMessageButton("قندهار", "قندهار", 0)]
